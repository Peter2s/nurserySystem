...
exports.classPost = [
    ...
    body("supervisor").isInt().withMessage("supervisor is require and must be number"),
...
exports.classUpdate = [
    ...
    body("supervisor").optional().isInt().withMessage("supervisor is require and must be number"),
